# Workflow
- **ALWAYS** track large tasks (not small user-directed edits) and progress in `plan.org`, adding more granular tasks in the hierarchy (as TODO subheadings and checkbox lists) when necessary before starting implementation.
