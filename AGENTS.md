...
- **ALWAYS** commit your work at the end of implementing a feature.
...
- Full documentation should be in the form of an Emacs manual for each package, written in org-mode and exported to info.
